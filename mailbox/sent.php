<?php
	...
	if(!$messages) echo 'Empty inbox';
		...
		foreach($messages as $m){
			...
			$output .= "<table class='msg old sent'>";
				$output .= "<tr>";
					$output .= "<td class=''>";
						$output .= "<div class='msg-preview' data-preview='sent' data-token='{$mToken}'>";
							$output .= "<p class='ellipsis'>To : <strong class='sender'>{$mRecever}</strong><br></p>";
