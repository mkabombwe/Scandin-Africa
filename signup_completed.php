	...
	<div class="form_container">
		<div class="signup_content first_container">
			...
			<div class="login_input_container">
				<p>Please check your email for the activation code. If you can't find the mail, check your spam folder.</p>
			</div>
			...
			<div class="navigation_field_container">
				<a id="login" href="login.php"><div id="next_link_1_1" class="next_button next_1">Login</div></a>
			</div>
		</div>
	</div>
</body>
