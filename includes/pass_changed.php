            ...
            <table style="width: 100% !important;border-collapse: collapse;">
                ...
                <tr>
                    <td class="content" style="background: white;padding: 30px 35px;">
                        ...
                        <h2 style="font-family: \'Avenir Next\', \'Helvetica Neue\', \'Helvetica\', Helvetica, Arial, sans-serif;margin-bottom: 20px;line-height: 1.25;font-size: 28px;">Your password has been changed</h2>

                        <p style="font-family: \'Avenir Next\', \'Helvetica Neue\', \'Helvetica\', Helvetica, Arial, sans-serif;font-size: 16px;font-weight: normal;margin-bottom: 20px;">Your password has been changed.<br>If you did this, please ignore this email. If you did not do this, please contact the Scandin-Africa support team.</p>
