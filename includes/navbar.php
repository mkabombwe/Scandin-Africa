...
<div class="navcontainer" hidden>
	...
	<div class="navigation">
		<ul>
			...
			<li><a href="#" onclick="scrollOpportunities()">Opportunities</a></li>
			<li><a href="#" onclick="scrollSectors()">Sectors</a></li>
			<li><a href="#" onclick="scrollPoints()">Key Points</a></li>
			<li><a href="#" onclick="scrollPricing()">Pricing</a></li>
			<li><a href="#" onclick="scrollPeople()">Key People</a></li>
	...
	<div class="connect">
		...
		<a class="login" href="main.php"><?php echo $f_name;?></a>
		<?php } else {?>
...
<div class="nav_phone">
	...
	<div class="navigation_phone">
		<ul>
			...
			<li><a href="#" onclick="scrollopportunities()">Opportunities</a></li>
			<li><a href="#" onclick="scrollSectors()">Sectors</a></li>
			<li><a href="#" onclick="scrollPoints()">Key People</a></li>
			<li><a href="#" onclick="scrollPricing()">Pricing</a></li>
			<li><a href="#" onclick="scrollPeople()">Key Points</a></li>
			<li><a href="#" onclick="scrollContact()">Contact</a></li>
			<?php if (logged_in()) {?>
			<li><a href="main.php"><?php echo $f_name;?></a></li>
